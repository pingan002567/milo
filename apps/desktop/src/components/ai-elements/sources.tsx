// Sources primitives copied from DeerFlow (bytedance/deer-flow) frontend
// ai-elements/sources.tsx, MIT License. Imports adapted to relative paths;
// structure/classNames unchanged.
